        ...
        <div class="col-5">
            <table class="table table-hover table-borderless table-striped text-center">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td><?= $busqueda['idinformes_varones'] ?></td>
                            <td> <a href="verPerfilVaron.php?idvarones=<?= $busqueda['idvarones'] ?>" id="link"><?= $busqueda['nombre'] ?></a> </td>
                            <td><?php
                                $busqueda['fecha'];
                                ...
                                ?></td>
                            <td>
                                <a href="verInformeVaron.php?idinformes_varones= <?= $busqueda['idinformes_varones'] ?>" class="btn btn-outline-dark btn-sm fw-bold"><i class="fas fa-eye"></i> Ver</a>
                            </td>
                        </tr>
                    <?php
                    }
