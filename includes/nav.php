            ...
            <div class="row mx-auto">
                <div class="col-12 p-0 text-center">
                    <ul class="nav py-0 px-5 bg-dark d-flex justify-content-between">
                        ...
                        <?php
                        } else if ($_SESSION['nombre'] == 'César Brochero') {
                        ?>
                            <li class="nav-item m-3">
                                <div class="row">
                                    <div class="col">
                            ...
                            <li class="nav-item m-3">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <a href="listaDiscursantesCongregacion.php" class="nav-item text-decoration-none text-primary">DISCURSANTES DE <br> LA CONGREGACIÓN</a>
                                    </div>
                                </div>
